        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              ...
              gain insights, and create innovative solutions that drive growth.
            </p>
          ...
          {[
            {
              ...
              description: 'Automate complex tasks and workflows with intelligent AI-powered solutions.',
              icon: (
            ...
            },
            {
              ...
              description: 'Transform raw data into actionable insights with advanced analytics and ML models.',
              icon: (
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
