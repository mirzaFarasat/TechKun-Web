...
const Navbar = () => {
    ...
    // Reset all menu states - this is a new function to centralize state reset logic
    ...
    // Listen for route changes to reset menu state
    useEffect(() => {
        // Reset menu states whenever the pathname changes
        resetMenuStates();
    }, [pathname]);
    ...
    // Cleanup scroll lock on unmount and when menu closes
    useEffect(() => {
    ...
    const handleNavigation = (href: string) => {
        resetMenuStates(); // Use the centralized reset function
        router.push(href);
    };
    ...
    return (
        <>
            ...
            {/* Mobile menu - Full screen overlay with immediate expansion */}
            {isMenuOpen && (
                <div className="md:hidden fixed inset-0 z-50 bg-gray-900">
                    {/* Close button positioned at the top right */}
                    <button
                        onClick={toggleMenu}
                        className="absolute top-6 right-6 p-2 text-gray-100 hover:text-white z-50 rounded-md"
                            ...
                            <div className="flex flex-col items-center space-y-8 w-full max-w-sm mx-auto">
                                ...
                                <div className="w-full">
                                    <div className="flex items-center justify-center space-x-2 mb-4">
                                        ...
                                        <button
                                            ...
                                            className="p-1 text-gray-300 hover:text-white transition-colors duration-200 rounded"
                                    ...
                                    {/* Services Submenu - Always rendered, controlled by opacity and height */}
                                    <div className={`
                                            ...
                                            {services.map((service) => {
                                                ...
                                                return (
                                                    <button
                                                        ...
                                                        className="flex items-center space-x-3 p-3 text-gray-200 hover:text-white 
                                                            hover:bg-gray-700 rounded-md transition-all duration-300 w-full text-left group"
                                                    >
                                                        <Icon className="h-5 w-5 text-blue-400 group-hover:text-blue-300 flex-shrink-0" />
                                                        <div>
                                ...
                                <button
                                    ...
                                    className="px-8 py-4 bg-blue-600 text-white text-lg font-medium rounded-lg 
                                        hover:bg-blue-700 transform hover:scale-105 transition-all duration-300 shadow-lg mt-8"
                                >
                                    Contact Us
                                </button>
                            </div>
            ...
            <div className={`
                ${isHomePage ? '' : 'h-20 md:h-24'} 
                ${isScrolled && !isHomePage ? 'h-16 md:h-20' : ''}
            `} />
        </>
    );
};
